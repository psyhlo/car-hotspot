...
QT_MOC_LITERAL(5, 67, 23), // "bluetoothPoweredChanged"
QT_MOC_LITERAL(6, 91, 7), // "powered"
QT_MOC_LITERAL(7, 99, 14), // "refreshDevices"
QT_MOC_LITERAL(8, 114, 15), // "setTargetDevice"
QT_MOC_LITERAL(9, 130, 7), // "address"
QT_MOC_LITERAL(10, 138, 16), // "setTargetDevices"
...
QT_MOC_LITERAL(29, 474, 18) // "isBluetoothPowered"
    ...
    "bluetoothPoweredChanged\0powered\0"
...
void BluetoothManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->bluetoothPoweredChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->refreshDevices(); break;
        case 4: _t->setTargetDevice((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (BluetoothManager::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BluetoothManager::bluetoothPoweredChanged)) {
                *result = 2;
                return;
            }
        }
        ...
        case 4: *reinterpret_cast< bool*>(_v) = _t->isBluetoothPowered(); break;
        default: break;
        }
...
// SIGNAL 2
void BluetoothManager::bluetoothPoweredChanged(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
